...
INSERT INTO "BIBLIOTECA" (ID, NOMBRE_BIBLIOTECA,CODIGO_BIBLIOTECA,MUNICIPIO_ID) VALUES (1, 'FIA','fia',6);

INSERT INTO "RECURSO_BIB" (ID, DESCRIPCION_RECURSO_BIB, DIGITAL_RECURSO_BIB, FISICO_RECURSO_BIB, IMAGEN_RECURSO_BIB, NOMBRE_RECURSO_BIB, SINOPSIS_RECURSO_BIB, TOTAL_RECURSO_BIB, TIPO_RECURSO_ID) VALUES ('1', 'Materia tranquila', '1', '1', 'a', 'Fisica resnick', 'sinopsis', '1', '1');
INSERT INTO "RECURSO_BIB" (ID, DESCRIPCION_RECURSO_BIB, DIGITAL_RECURSO_BIB, FISICO_RECURSO_BIB, IMAGEN_RECURSO_BIB, NOMBRE_RECURSO_BIB, SINOPSIS_RECURSO_BIB, TOTAL_RECURSO_BIB, TIPO_RECURSO_ID) VALUES ('2', 'Materia dificil', '2', '2', 'b', 'Filosofia', 'Astralidades', '2', '2');


INSERT INTO "BIB_RECURSO_BIB" (BIBLIOTECA_ID,RECURSO_BIB_ID) VALUES (1, 1);
