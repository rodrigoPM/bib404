...
INSERT INTO "BIBLIOTECA" (ID, NOMBRE_BIBLIOTECA,CODIGO_BIBLIOTECA,MUNICIPIO_ID) VALUES (10, 'FIA','fia',6);

INSERT INTO "RECURSO_BIB" (ID, DESCRIPCION_RECURSO_BIB, DIGITAL_RECURSO_BIB, FISICO_RECURSO_BIB, IMAGEN_RECURSO_BIB, NOMBRE_RECURSO_BIB, SINOPSIS_RECURSO_BIB, TOTAL_RECURSO_BIB, TIPO_RECURSO_ID) VALUES ('1', 'Materia trankila', '1', '1', 'a', 'Fisica resnick', 'sinopsis', '1', '1');
INSERT INTO "RECURSO_BIB" (ID, DESCRIPCION_RECURSO_BIB, DIGITAL_RECURSO_BIB, FISICO_RECURSO_BIB, IMAGEN_RECURSO_BIB, NOMBRE_RECURSO_BIB, SINOPSIS_RECURSO_BIB, TOTAL_RECURSO_BIB, TIPO_RECURSO_ID) VALUES ('2', 'b', '2', '2', 'b', 'b', 'b', '2', '2');


INSERT INTO "BIB_RECURSO_BIB" (ID,BIBLIOTECA_ID,RECURSO_BIB_ID) VALUES (3, 1, 1);
