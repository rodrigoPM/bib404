...
public class PerfilController {
	...
	@GetMapping("/editar")
	public String editar(@RequestParam(name = "id", required = false) int id, Model model) {
	...
	public String addperfil(@ModelAttribute(name = "perfilModel") PerfilModel perfilModel, HttpServletRequest request,
			@ModelAttribute("bib") String bib, @ModelAttribute("mun") String mun) {
